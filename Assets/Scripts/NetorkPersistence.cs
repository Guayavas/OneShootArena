...
public class NetorkPersistence : MonoBehaviour
{
    ...
    public GameObject ObtenerPrefabJugador(int indiceNave)
    {
        ...
        {
            Debug.LogWarning("No hay prefabs seleccionables asignados. Se usar\xe1 prefabJugador por defecto.");
            return prefabJugador;
        }

        Debug.LogError("No hay ning\xfan prefab de jugador asignado en NetorkPersistence.");
        return null;
    }
}
